...
protonation_flag = "-p"
if(protonation_flag in sys.argv):
    to_protonate = sys.argv[sys.argv.index(protonation_flag) + 1]
    to_protonate = ((to_protonate == "y") or (to_protonate == "1"))
else:
    # default way is to protonate
    to_protonate = True
...
if(to_protonate):
    ...
    shutil.copyfile(pdb_filename, protonated_file)
    print('no protonation')
